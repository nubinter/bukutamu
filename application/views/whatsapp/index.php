<style>
  ...
  .nav-tabs .nav-link.active {
    ...
    color: white;
    /* Ganti warna teks agar lebih terlihat */
  }
  ...
  $('.list-table ul').on('click', 'li .dropdown .dropdown-item.btnQr', function(event) {
        ...
        $.ajax({
            ...
            success: function(json) {
              if (json.qr.success) {
                $('.modal#modalQr #qr_result').html('<center><img class="img-responsive" src="<? base_url('assets/img/design/HeaderWA.png') ?>" style="width:310px;" /><br /><img src=' + json.qr.code + ' /><br /><img class="img-responsive" src="<?= base_url('assets/img/design/FooterWA.png') ?>" style="width: 350 px;" /></center>');
                }
                else {
                  if (json.qr.status == 0) {
                  ...
                  if (json.qr.status == 1) {
                    $('.modal#modalQr #qr_result').html('<center><img src="<?= base_url('assets/img/design/ConnectedQR.png') ?>" alt="WhatsApp sudah terkoneksi!" width="350px" height="350px" ></center>');
                  }
                }
              }
            })
            ...
            success: function(json) {
              if (json.status == 1) {
                if (json.qr.success) {
                  ...
                  $('.modal#modalNewDevice #qr_result').html('<center><img class="img-responsive" src="<?= base_url('assets/img/design/HeaderWA.png') ?>" style="width:310px;" /><br /><img src=' + json.qr.code + ' /><br /><img class="img-responsive" src="<?= base_url('assets/img/design/FooterWA.png') ?>" style="width:350px;" /></center>');
                } else {
                  if (json.qr.status == 0) {
                    $('.modal#modalNewDevice #qr_result').html(json.qr.message);
                  }
                  if (json.qr.status == 1) {
                    $('.modal#modalNewDevice #qr_result').html('<center><img src="<?= base_url('assets/img/design/ConnectedQR.png') ?>" alt="Whatsapp sudah terkoneksi!" width="350px" height="350px" ></center>');
                  }
                }
              }
              if (json.status == 2) {
      ...
      <?php if ($user['role'] == 1) { ?> $('#nav-user-tab').on('click', function(event) {
          event.preventDefault();
